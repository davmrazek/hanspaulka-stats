...
// The first tab is the default; #hash deep-links to any tab. A compound hash
// like #h2h=slug selects the "h2h" tab (part before "="); the panel's own
// script reads the rest. Without JS all panels stay visible (CSS hides them
// only under html.js).
(function () {
  ...
  window.addEventListener("hashchange", () => show(tabFromHash(), false));
  show(tabFromHash() || names[0], false);
})();
